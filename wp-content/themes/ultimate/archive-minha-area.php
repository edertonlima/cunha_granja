...
<div class="main-title" style="">
	<div class="container">
		<span class="categoria">ÁREA RESTRITA</span>
			...
			<div class="col-12">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="<?php echo get_home_url(); ?>/minha-area" class="login form-padrao" method="post">
							...
							<fieldset class="col-12">
								<button type="submit" class="btn btn-saiba-mais enviar">Entrar</button>
								<!--<a href="javascript:" class="btn enviar">Entrar</a>-->
							</fieldset>

							<fieldset class="col-12">
								<p class="msg-form"></p>
								<p>Primeiro acesso? <a href="<?php echo get_home_url(); ?>/cadastro" class="inline" title="Cadastre-se aqui">Cadastre-se aqui.</a></p>
							</fieldset>
