...
function change_post_object() {
    ...
    $labels->name = 'Dicas e Receitas';
    $labels->singular_name = 'Dicas e Receitas';
    $labels->add_new = 'Adicionar';
    $labels->add_new_item = 'Adicionar';
    $labels->edit_item = 'Editar';
    $labels->new_item = 'Dicas e Receitas';
    ...
    $labels->menu_name = 'Dicas e Receitas';
    $labels->name_admin_bar = 'Dicas e Receitas';
}
