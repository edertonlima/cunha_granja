...
<div class="main-title" style="">
	<div class="container">
		...
		<h3 class="titulo">Novo Cadastro</h3>
		<p class="subtitulo">
			<?php 
			...
			<div class="col-12">
				<form action="<?php the_permalink(); ?>" class="cadastro" method="post">
					<div class="row">
						...
						<fieldset class="col-12">
							<button type="submit" class="btn btn-saiba-mais enviar">Cadastrar</button>
						...
						<fieldset class="col-12">
							...
							<?php if(!isset($_SESSION['id'])){ ?>
								<p>Já possui acesso? <a href="<?php echo get_home_url(); ?>/minha-area" title="Acessar minha área" class="inline">Clique aqui.</a></p>
							<?php } ?>
						</fieldset>
