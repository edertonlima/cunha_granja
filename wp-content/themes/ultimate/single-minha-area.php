...
<?php get_header(); ?>
	...
	<div class="main-title" style="">
		<div class="container">
			...
			<h3 class="titulo" id="page-area"></h3>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-9">
				<div class="content-tab">
					...
					<div class="cont-tab-area tab" id="novo-pedido">
						...
						<?php }else{ ?>
							...
							<p style="clear: both; margin-top: 30px; float: left; margin-left: 30px;">Nenhum produto encontrado.</p>

						<?php } ?>

					</div>
					<div class="cont-tab-area tab" id="meus-pedidos">
						meus pedidos
					</div>
					<div class="cont-tab-area tab" id="meus-dados">
						<?php
							while ( have_posts() ) : the_post(); ?>
